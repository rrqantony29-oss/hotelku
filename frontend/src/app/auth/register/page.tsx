    ...
    <div className="bg-[#f8f9ff] min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <h1 className="text-4xl font-bold leading-tight mb-4">
            Mulai Perjalanan<br />Anda Bersama Kami
          </h1>
          <p className="text-lg text-white/80 leading-relaxed max-w-md">
            {role === "customer"
              ? "Daftar sekarang dan nikmati kemudahan booking hotel di seluruh Indonesia dengan harga terbaik."
              : "Bergabunglah sebagai mitra hotel dan jangkau ribuan tamu potensial di seluruh Indonesia."
            }
          </p>
          <div className="mt-12 space-y-4">
            {[
              "Akses ke 500+ hotel di seluruh Indonesia",
              "Harga kompetitif & penawaran eksklusif",
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-2xl font-bold text-[#121c2a] mb-2">Buat Akun Baru</h2>
          <p className="text-sm text-[#434655] mb-6">Lengkapi data di bawah untuk mendaftar</p>

          {/* Role Selector */}
          <div className="mb-6">
            <label className="text-sm font-medium text-[#121c2a] mb-2 block">Daftar Sebagai</label>
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
                  role === "customer" ? "bg-[#004ac6]" : "bg-[#dee9fc]"
                }`}>
                  <User className={`h-5 w-5 ${role === "customer" ? "text-white" : "text-[#004ac6]"}`} />
                </div>
                <div className="text-left">
                  <p className={`text-sm font-semibold ${role === "customer" ? "text-[#004ac6]" : "text-[#121c2a]"}`}>Customer</p>
                  <p className="text-xs text-[#434655]">Pesan hotel</p>
                </div>
              </button>
              <button
              ...
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
                  role === "partner" ? "bg-[#004ac6]" : "bg-[#dee9fc]"
                }`}>
                  <Building2 className={`h-5 w-5 ${role === "partner" ? "text-white" : "text-[#004ac6]"}`} />
                </div>
                <div className="text-left">
                  <p className={`text-sm font-semibold ${role === "partner" ? "text-[#004ac6]" : "text-[#121c2a]"}`}>Hotel Partner</p>
                  <p className="text-xs text-[#434655]">Kelola hotel</p>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-[#434655]" />
                <Input
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-[#434655]" />
                <Input
            ...
            <div>
              <label className="text-sm font-medium text-[#121c2a] mb-1.5 block">Password *</label>
              <div className="relative">
            ...
            <div>
              <label className="text-sm font-medium text-[#121c2a] mb-1.5 block">Konfirmasi Password *</label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-[#434655]" />
                <Input
                  type="password"
            ...
            <div className="flex items-start gap-3">
              <button
                ...
                className={`w-5 h-5 rounded-md flex items-center justify-center shrink-0 mt-0.5 transition ${
                  agreeTerms ? "bg-[#004ac6]" : "bg-[#dee9fc]"
                }`}
              >
              ...
              <p className="text-sm text-[#434655]">
                Saya menyetujui{" "}
                <span className="text-[#004ac6] font-medium hover:underline cursor-pointer">Syarat & Ketentuan</span>
                {" "}dan{" "}
                <span className="text-[#004ac6] font-medium hover:underline cursor-pointer">Kebijakan Privasi</span>
                {" "}HotelKu
              </p>
            </div>
          ...
          <p className="text-center text-sm text-[#434655] mt-8">
            Sudah punya akun?{" "}
            <Link href="/auth/login" className="text-[#004ac6] font-semibold hover:underline">
              Masuk di sini
            </Link>
          </p>
        </div>
